function Transport_REST_HTTC(oOptions){
    ...
    function transformJSON(data){
        ...
        if(data.participant && data.participant.type){

	        switch(data.participant.type){

	            case "Customer":            data.participant.type = "Client";               break;
	            case "Agent":               data.participant.type = "Agent";                break;
	            case "External":            data.participant.type = "External";             break;
	        }
	    }
        ...
        out.party = {
            ...
            id: (data.participant)?parseInt(data.participant.participantId):"",
            type: (data.participant)?data.participant.type:"",
            name: (data.participant)?data.participant.nickname:""
        };
